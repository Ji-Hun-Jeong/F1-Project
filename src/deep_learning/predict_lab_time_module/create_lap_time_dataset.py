from Users.project.train_process.data_state import IDatasetCreator, DataFeaturing, EFeatureType
from Users.project.train_process.my_utils import timedelta_to_seconds
import pandas as pd
...
"""
    ...
    랩 시간, 랩 넘버, 
"""
class LapTimePredictDatasetCreator(IDatasetCreator):
